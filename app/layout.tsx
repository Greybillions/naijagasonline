...
const ogImageUrl = 'https://www.naijagasonline.com.ng/og-image.jpg'; // must be in /public
...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'NaijaGasOnline Team', url: 'www.naijagasonline.com.ng' }],
  creator: 'NaijaGasOnline',
  metadataBase: new URL('www.naijagasonline.com.ng'),
  openGraph: {
